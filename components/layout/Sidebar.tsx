...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex w-64 flex-col overflow-hidden border-r border-white/10 bg-sidebar-brand text-white shadow-[12px_0_35px_rgba(6,27,58,0.18)]">
      ...
      <div className="relative space-y-3 px-3 pb-4">
        ...
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.06] p-4 shadow-[0_12px_28px_rgba(0,0,0,0.10)] backdrop-blur-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm font-semibold text-white">v0.1</p>
            </div>
          </div>
        ...
        {logoutError ? (
          <div className="rounded-xl border border-red-300/15 bg-red-300/10 px-3 py-2.5">
            <p className="text-xs leading-5 text-red-200">{logoutError}</p>
          </div>
        ) : null}
